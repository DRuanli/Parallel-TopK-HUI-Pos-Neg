...
public class ver6 {
    ...
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            EnhancedUtilityList joined = ver6.this.join(prefix, extension);
    ...
    public ver6(Map<Integer, Double> itemProfits, int k, double minPro) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ver6 algorithm = new ver6(profits, k, minPro);
