 ...
 * 1. Fix Probability Aggregation: remove itemProb and related calculation
 * 2. Fix Remaining Utility Cal: fix redudant checking rank (calRemUti4E Class)
 * 3. Fix TopK tryAdd for thread-safe
 *
 * @author Elio
 * @version 3.2
 */
public class ver3_2 {
    ...
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            EnhancedUtilityList joined = ver3_2.this.join(prefix, extension);
    ...
    public ver3_2(Map<Integer, Double> itemProfits, int k, double minPro) {
    ...
    private double calculateRemainingUtilityForElement(EnhancedTransaction trans, int position,
        ...
        // Since items are already sorted by rank, all items after position have higher rank
    ...
    public static void main(String[] args) throws IOException {
        ...
        ver3_2 algorithm = new ver3_2(profits, k, minPro);
