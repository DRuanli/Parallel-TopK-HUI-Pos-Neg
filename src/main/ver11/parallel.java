 ...
 *
 * Parallel implementation using ForkJoin framework with lock-free top-k management
 */
public class parallel {
    ...
    // ============================================================================
    // FORKJOIN TASKS FOR PARALLEL PROCESSING
    // ============================================================================

    /**
     * Parallel task for processing single-item prefixes
     * Splits work across threads using work-stealing pattern
     */
     ...
     * Recursively mines larger itemsets from prefix + extension combinations
     */
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            UPUList joined = parallel.this.join(prefix, extension);
    ...
    public parallel(Map<Integer, Double> itemProfits, int k, double minPro, boolean debug, boolean debugVerbose) {
    ...
    public List<Itemset> mine(List<Transaction> rawDatabase) {
        if (DEBUG) {
            System.err.println("[DEBUG] ===== PTK-HUIM-U± Algorithm Started =====");
    ...
    public static void main(String[] args) throws IOException {
        if (args.length < 4 || args.length > 5) {
            System.err.println("Usage: parallel <database_file> <profit_file> <k> <min_probability> [--debug | --debug-verbose]");
            System.exit(1);
        }
