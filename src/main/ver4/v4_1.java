...
public class ver4_1 {
    ...
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            EnhancedUtilityList joined = ver4_1.this.join(prefix, extension);
    ...
    public ver4_1(Map<Integer, Double> itemProfits, int k, double minPro) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ver4_1 algorithm = new ver4_1(profits, k, minPro);
