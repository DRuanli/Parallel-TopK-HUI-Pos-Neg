 ...
 *
 * VERSION 4_1_1 IMPROVEMENTS:
 * 1. Eliminated Slow Loops
 * 2. Minimized Lock Scope
 * 3. Added Lock-Free Filtering
 *
 * @author Elio
 * @version 4.1.1
 */
public class ver4_1_1 {
    ...
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            EnhancedUtilityList joined = ver4_1_1.this.join(prefix, extension);
    ...
    public ver4_1_1(Map<Integer, Double> itemProfits, int k, double minPro) {
    ...
    private EnhancedUtilityList join(EnhancedUtilityList ul1, EnhancedUtilityList ul2) {
        ...
        // OPTIMIZATION: Pre-sized collection to prevent resizing
    ...
    public static void main(String[] args) throws IOException {
        ...
        ver4_1_1 algorithm = new ver4_1_1(profits, k, minPro);
