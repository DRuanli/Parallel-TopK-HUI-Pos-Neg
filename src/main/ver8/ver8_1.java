...
public class ver8_1 {
    ...
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            EnhancedUtilityList joined = ver8_1.this.join(prefix, extension);
    ...
    // Constructor
    public ver8_1(Map<Integer, Double> itemProfits, int k, double minPro) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ver8_1 algorithm = new ver8_1(profits, k, minPro);
