...
public class ver8 {
    ...
    private class ExtensionSearchTask extends RecursiveAction {
        ...
        private void processExtension(int index) {
            ...
            EnhancedUtilityList joined = ver8.this.join(prefix, extension);
    ...
    // Constructor
    public ver8(Map<Integer, Double> itemProfits, int k, double minPro) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ver8 algorithm = new ver8(profits, k, minPro);
